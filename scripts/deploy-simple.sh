...
# Simple Deployment Script for EvenX Website
# This script works with existing permissions and doesn't require IAM changes
...
echo "🚀 Deploying EvenX Website to existing GKE cluster..."
...
echo ""
echo "⚠️  Note: You'll need to manually build and push the Docker image to GCR"
echo "   or ask your project admin to grant IAM permissions for automated deployment"
